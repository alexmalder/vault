Nawaz Dhandala · February 2, 2026 · [oneuptime.com](https://oneuptime.com/blog/post/2026-02-02-vault-docker/view)
...
KV Secrets EngineVault ServerApplicationKV Secrets EngineVault ServerApplicationAuthenticate (Token/AppRole)Authentication SuccessWrite Secret (PUT /secret/data/myapp)Store Encrypted SecretSuccessSecret StoredRead Secret (GET /secret/data/myapp)Retrieve SecretEncrypted DataDecrypted Secret
...
PostgreSQLVault ServerApplicationPostgreSQLVault ServerApplicationApplication uses databaseRequest database credentialsCREATE ROLE with expirationRole createdTemporary username/passwordConnect with temp credentialsConnection establishedRevoke credentials (on TTL expiry)Role dropped
...
Technically validated - Jun 06, 2026
...
[Edit this post on GitHub](https://github.com/oneuptime/blog/tree/master/posts/2026-02-02-vault-docker) [Contributing guidelines](https://github.com/oneuptime/blog)
